...
function doPost(e) {
  ...
  try {
    ...
    if (body.accion === 'boletas_arba') {
      return responseJson(bajarBoletasArba(body.solo_contar === true), 200)
    }
