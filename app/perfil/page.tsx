...
export default async function PerfilPage() {
  ...
  return (
    <LayoutApp userRole={rol} secciones={secciones} preferencias={preferencias}>
      <div>
        <h1 className="titulo-pantalla">Tu perfil</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Tu nombre, tu foto, cómo te abre la app y el estado de tu segundo factor.
        </p>
      </div>
      <PanelPerfil userRole={rol} secciones={secciones} />
    </LayoutApp>
  )
}
