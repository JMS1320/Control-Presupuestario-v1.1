...
| **A-DAT-10** | 🔴 | Dato | **El lote de 40 tiene desbaste 8 % y CZ 6 %, y la tabla dice 5 % y 3 %** — con el peso a la venta corregido a **371,40 kg**, la tabla da desbaste **5 %** (banda 330-380) y CZ **3 %** (≤380). El lote tiene guardados **8 %** y **6 %**, que corresponden a un peso **>380** — se cargaron en algún momento en que la curva daba de más, probablemente mientras se peleaba con el input de [A-BUG-68](#a-bug-68). Efecto: **445 kg netos de menos** ≈ **$2,36 M** de ingreso. 📌 **La app lo está avisando**: el modal del lote muestra *«tabla: 5 %»* en ámbar y ofrece el botón *Aplicar los valores de la tabla* — pero sólo se ve entrando al lote | → [A-DAT-10](#a-dat-10) `@productivo` |
