...
| **A-DEC-13** | 🔴 | Dec | **Cómo se trata la mortandad en el reparto del consumo** — hay que decidirla antes de tocar [A-BUG-92](#a-bug-92) · **(a)** *Cada muerto es un grupo con `hasta` = la fecha de su muerte*: come mientras vivió, deja de comer cuando murió, y **su costo queda identificado por animal y por fecha**. Es lo que pide la regla ya escrita (*«la mortandad es un costo y se adjudica; los muertos a su peso real»*) y da **$8.118 / $10.824 / $29.128 / $34.764** — se ve barato el que muere temprano y caro el que muere tarde, que es la verdad. **(b)** *El muerto no come nada*: su comida se reparte entre los vivos. Más simple, pero **esconde el costo de la mortandad** justo cuando se quiere medir. **(c)** *Como está hoy*: un grupo inmortal — **no es una opción, es el bug**. 📌 **Recomiendo (a)**, y es lo que ya está calculado y verificado. ⚠️ **Antes hay que resolver un dato**: las 4 «sin lote» son **2 machos + 2 hembras**, pero los muertos son **3 machos + 1 hembra** — el total cierra y la composición no. Ver [A-DAT-18](#a-dat-18) | → [A-DEC-13](#a-dec-13) `@productivo` |
| **A-DAT-18** | 🔴 | Dato | **Tres fuentes dan tres números distintos de machos destetados: 106 / 107 / 104** · Apareció al investigar [A-BUG-92](#a-bug-92). **`ciclos_recria`** dice **106 machos + 83 hembras**; los **movimientos de hacienda** del destete (23/02) dicen **100 Ternero + 7 Torito = 107 machos + 82 hembras**; los **lotes** suman **104 machos + 81 hembras**. Los totales cierran (189 / 189 / 185+4) pero **la composición por sexo no**. 📌 Se suma una cuarta rareza: el movimiento del **26/04** dice `Torito −8 (cambio categ → Toro)` **cuando el destete había registrado 7**, y el lote de toritos dice **9**. 📌 La nota del ciclo ya avisaba: *«stock_ciclos 25/26 dice 107 machos destetados y la pesada tiene 103 — 4 sin pesar»*. ⚠️ **Hoy no rompe el número** —el consumo se reparte por kilo-día y el total no depende del sexo— **pero sí va a romper el margen por grupo** y cualquier control de existencias. ❓ **Sólo lo puede resolver el usuario**: cuál es la fuente buena | → [A-DAT-18](#a-dat-18) `@productivo` |
