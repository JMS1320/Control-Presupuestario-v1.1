...
| **A-DEC-11** | 🔴 | Dec | **¿El maíz de los 9 toritos es costo de Cría o de Recría? — $944.710 en juego** · Al mirar el reparto ya calculado aparece que los **toritos van a «Cria»**, no a Recría: la categoría `Torito` apunta a ese centro de costo en `productivo.categorias_hacienda`. **No es un bug** — es una imputación, y la decisión es del usuario. A favor de **Cría**: el torito es un futuro reproductor, un activo del rodeo de cría, y su comida es costo de tenerlo. A favor de **Recría**: está **en el ciclo de recría**, comiendo del **mismo silo**, y el usuario lo dijo desde el principio (*«comen todos los machos incluidos los 9 toritos»*) — dejarlo en Cría hace que el margen de Recría se vea mejor de lo que es. 📌 **Lo que NO cambia con la decisión**: el total. El kilo-día sólo reparte, así que los $944.710 salen de una actividad y entran en la otra. 📌 **Se resuelve con un dato, no con código**: el `centro_costo_id` de la categoría `Torito`. ⚠️ **Conviene decidirlo antes del balance 25/26** (§ [A-FEAT-09](#a-feat-09)): es plata que cambia de margen | → [A-DEC-11](#a-dec-11) `@productivo` |
| **A-FEAT-66** | 🟡 | Feat | **Un tramo de consumo que cruza el cierre del ejercicio se carga entero al ejercicio de su fecha de inicio — y ahora eso son ~$4,1 M** · `costo-alimentacion.ts` lo tiene decidido y comentado: *«un tramo cae entero en la campaña de su fecha de INICIO; partirlo por días inventaría una precisión que la medición no tiene»*. La decisión es **buena y no se discute**. Lo que faltaba es **ver el impacto**: el tramo **24/06→24/07** son **20.100 kg / $5,38 M**, y de sus 30 días **sólo 7 son del ejercicio 25/26** — los otros 23 son 26/27. Cargarlo entero a 25/26 le suma ~**$4,1 M** al ejercicio que está por cerrar (corte **30/06/2026**, al contador **01/10/2026**). 📌 **La salida NO es partir el tramo por días** — es **medir el 30/06**. Una medición en la fecha de cierre corta el tramo donde corresponde y el problema desaparece sin inventar nada: es la misma regla de siempre, *un corte existe cuando hay una MEDICIÓN*. **Propuesta**: que la pantalla **avise cuando un tramo cruza el cierre del ejercicio** y ofrezca cargar la medición de esa fecha. Para este año ya pasó — habría que ver si el usuario tiene el dato del silo al 30/06 | → [A-FEAT-66](#a-feat-66) `@productivo` |
