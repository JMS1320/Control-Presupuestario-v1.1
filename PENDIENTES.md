...
| A-DAT-25 | 🔴 | **Dato** | **Las 21 PARTIDAS del inmobiliario** — el usuario las tiene que pasar. Los templates ya existen con el nombre del lote (no hace falta que los pase); falta **sólo el número de partida** de cada uno. Bloquea `A-FEAT-95` (bajar las boletas de ARBA y archivarlas) | `@arba` |
