...
| A-TEST-97 | 🟢 | Test | **`npm run probar:mag`** — la ruta de precios contra el sitio real, **sólo lectura**. 12 casos: 18 categorías · **la fila «Totales» NO entra** (daría 35.210 cabezas en vez de 17.605) · `importe ÷ kilos = promedio` en todas · el `estado` · y los adversarios (fin de semana → 404 explicando, fecha mal → 400). ⚠️ Si no hay internet avisa y saltea, en vez de fallar por la red | `@ganaderia` |
