...
| A-BUG-104 | 🟢 | **Alta** | **ARREGLADO 2026-09-05 (sin testear → A-TEST-89).** Ahora `encolarMailDetalle` verifica **suma(medios) + retención + descuento = importe** (tolerancia $1) y **si no cierra NO encola nada**: devuelve la diferencia, el desglose que encontró y si sobra o falta un medio. Es el control que le saca al usuario la dependencia de preguntar | 6 mails encolados `@cashflow` |
