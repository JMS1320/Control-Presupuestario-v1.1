...
| A-FEAT-104 | 🔴 | **Alta** | **Reemplazar las cuotas PROYECTADAS con la boleta real cuando llega.** Ahí está el valor de bajar las boletas: hoy las cuotas 1 y 2 son reales y **conciliadas**, pero las **3 y 4 se proyectan repitiendo el monto de la 2**. ⏰ **La cuota 3 vence el 08/09/2026** — su boleta ya debería estar en el mail. Al bajarla, la app propone el monto real y **el usuario decide si lo aplica** (nunca automático, `A-FEAT-95`) | `@presupuesto` `@arba` |
