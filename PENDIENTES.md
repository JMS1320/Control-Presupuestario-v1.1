...
| M-02 | 🟡 | **Cría precargada en Productivo** (2026-08-03) — 12 costos sacados del Excel, editables. ⚠️ **El silo va por TONELADA y quedó como `monto_ha`**; siembra de verdeos y gas oil en 0. Es el experimento que decide si `presupuesto_variables` se retira |
