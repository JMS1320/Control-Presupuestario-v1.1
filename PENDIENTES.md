...
| A-BUG-110 | 🔴 | **ALTA** | 💰 **El inmobiliario está cargado $17,3 M por encima de las boletas.** Comparados los 16 lotes cuya boleta 2026 tenemos: cargado **$33.429.968** contra **$16.127.465** real. 🔑 **Son dos cosas distintas y hay que separarlas**: 13 lotes están **+14 a +16 %** parejo (puede ser una proyección deliberada de aumento), pero **tres son errores**: **Rojas +167 %** ($20.941.123 vs $7.856.195 → **$13,1 M de más**), **Casco +76 %** ($3,4 M) y **Ombu +31 %** ($0,5 M). Esos tres solos son **$17,0 M de los $17,3 M**. ⚠️ Todos los montos «Anual» cargados terminan en **`123`**: son valores tipeados a mano, no boletas. **Decisión del usuario**: ¿pisamos con la boleta, o el +15 % es a propósito? | `@presupuesto` `@arba` |
