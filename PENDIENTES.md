...
| A-FEAT-94 | 🟡 | **Alta** | **EN CURSO.** ✅ **3 tablas creadas** (`productivo.romaneos` / `romaneo_medias` / `romaneo_lineas`, con GRANTs) y ✅ **parser escrito y probado contra el romaneo real**: cabecera completa, **9/9 líneas de liquidación exactas** y **5 de 6 controles cierran** ($18.750.900, 3.354 kg, 6.260 vivos, 10 cabezas, rinde 53,58). ⚠️ Lee **18 de 20 medias reses** — 2 quedan fuera porque el PDF las posiciona en otro espacio de coordenadas; **el control lo detecta y lo dice** (3.049 vs 3.354). ⏳ **Falta la pantalla**: subir el PDF → comparar contra la app → editar → confirmar | `@ganaderia` |
