...
| **A-DOC-09** | 🟢 | Doc | **La confusión que vale la pena tener escrita: un respaldo parcial NO es una compra nueva** — al explicarle el arreglo de Longo, el usuario preguntó *«¿o sea que es hacer una compra nueva de 4900 para la factura de 25T?»*. **No**: crear una compra de 4.900 kg habría subido el stock de **66.660 a 71.560** con mercadería que nunca llegó. Las 4,9 t **ya están dentro** de la entrega de 25.000 del 24/07; lo que faltaba era un **segundo respaldo para esa misma entrega**. La analogía que lo cerró: *como pagar una compra con dos cheques — son dos comprobantes, una sola compra*. 📌 Vale registrarla porque **es la pregunta natural**: el modelo de muchos-a-muchos no es obvio, y equivocarse acá inventa stock sin que nada avise | → [A-DOC-09](#a-doc-09) `@productivo` |
...
## <a id="a-doc-09"></a>A-DOC-09 — Un respaldo parcial no es una compra nueva
