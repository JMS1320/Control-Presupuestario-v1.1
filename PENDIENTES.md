...
| A-TEST-75 | 🔴 | Test | **El Margen muestra el costo de alimentación medido** ([A-BUG-90](#a-bug-90)) — en *Presupuesto → Margen*, campaña **25/26**: la fila de Recría tiene que decir **Maíz Granel · 39.660 kg · $10.211.404**, y al desplegarla verse los **10 pasos** (5 grupos × 2 tramos) arrancando por *16/03/2026→24/06/2026 · Ternero Recria (55 cab): 6.521 kg*. En **26/27**: Recría **Maíz 17.926 kg · $4.788.721** y **Concentrado Novillo 35 10 · 1.729 kg · $1.260.487**. ⚠️ **El que prueba el fix es el tramo del 16/03**: si esa línea no aparece, el respaldo de template volvió a quedar afuera. Sumando las dos campañas y las dos actividades tiene que dar **$17.205.323**, que es exactamente el costo del consumo medido ($15.856.673 de maíz + $1.348.650 de concentrado) | → [A-TEST-75](#a-test-75) `@productivo` |
