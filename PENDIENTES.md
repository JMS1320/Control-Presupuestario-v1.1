...
| **A-FEAT-70** | 🟡 | Feat | **Un tramo corto amplifica el error de medición — y la curva de ración lo va a heredar** ([A-FEAT-68](#a-feat-68) es su hermana) · El tramo **24/08→29/08** dura **5 días** y da **2,31 % del peso vivo**, cuando la serie venía **0,43 → 1,35 → 1,51**. Puede ser real (invierno pleno) o puede ser la medición: la nota del maíz dice *«Kg dentro de Racion»* y **no menciona el silo**, mientras que la del concentrado sí sumó ración **+ bolsas**. 🔑 **Lo importante no es este caso, es la propiedad**: un error de 500 kg mueve el tramo de 5 días un **11 %** y el de 100 días un **2 %**. Como el % de ración medido es lo que va a alimentar la proyección estacional de [A-FEAT-68](#a-feat-68), **un tramo corto ruidoso puede contaminar la curva entera**. **Propuesta**: al construir la curva, **ponderar por días** y **marcar los tramos de menos de ~10 días** como poco confiables — mostrarlos, no descartarlos en silencio. ❓ Confirmar con el usuario si el silo estaba vacío el 29/08 | → [A-FEAT-70](#a-feat-70) `@productivo` |
