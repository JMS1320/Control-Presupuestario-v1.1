...
- **B-FEAT-VENTAS-COBROS — Importar ventas y registrar cobros (incl. retenciones que no entran a banco)** — *analizado 2026-07-01, falta definir 4 puntos*:
  ...
  - **⏳ Fase 2 (NO hecho)**: caso complejo **cuenta corriente / compensación** (AFA: venta granos ↔ compra insumos, cobrar saldo neto). + Pantalla de **consulta/reportes** ventas↔facturas↔cobros (sub-tarea de consulta).
